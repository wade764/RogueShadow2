...
public class Entity {
    ...
    private World world = Game.getWorld(); //somehow this being instantiated is still received as null
    ...
    public boolean move(int rowChange, int colChange, Room room, Room2 room2, Room3 room3) {
        // find new position
        whatMap = world.getRoom(); //currently having issues with this line, gives NullPointerException
